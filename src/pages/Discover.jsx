        ...
        <div className='mb-8 shadow-md rounded-md border border-slate-200 bg-white/80'>
          <div className='p-6 '>
            <div className='  relative'>
              ...
              <input type="text" placeholder='Search people by name, username, bio, or location...' className='pl-10 sm:pl-12 py-2 w-full border' onChange={(e) => setInput(e.target.value)} value={input} onKeyUp={handleSearch} />
