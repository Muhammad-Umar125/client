    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Share your thougts with the world</p>
        </div>
        {/* form */}
        <div className='border max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          {/* header */}
          ...
          <div>
            ...
            <div className='flex items-center  justify-between pt-3 border-t border-gray-300'>
              ...
              <button disabled={loading} onClick={()=>toast.promise(handleSubmit(),
                ...
                )} className='text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white I font-medium px-8 py-2 rounded-md cursor-pointer'>
                Publish Post
              </button>
            </div>
          </div>
